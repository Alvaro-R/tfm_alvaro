...
def calculate_maccs_keys(smiles: str) -> pd.DataFrame:
    ...
    maccs_keys_names = ["maccs" + str(i) for i in range(167)]
...
def calculate_ecfp4_fingerprints(smiles: str) -> pd.DataFrame:
    ...
    nBits = 1024
    ecfp4_fingerprints_names = ["ecfp4" + str(i + 1) for i in range(nBits)]
...
# FUNCTION TO CALCULATE KLEKOTA-ROTH KEYS FOR A MOLECULE
...
# FUNCTION TO CALCULATE QED PROPERTIES FOR A MOLECULE
